      ...
      <div className="grid grid-cols-4 gap-5 place-items-center">
        {mainCategories.map((item) => (
          <>
            <div
              key={item.label}
              className="flex flex-col items-center justify-center w-20 h-20 bg-gradient-to-r from-indigo-300 via-indigo-400 to-indigo-500 p-2 border-2 rounded-full hover:bg-gray-500/50 cursor-pointer"
            >
